...
func appConf() (*asset, error) {
	...
	info := bindataFileInfo{name: "app.conf", size: 876, mode: os.FileMode(438), modTime: time.Unix(1495375701, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
